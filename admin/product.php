...
<table border="1" cellpadding="2" bordercolor="#C9C9C9" width="100%">
	<tr>
	  <th width="24" class="title"><input type="checkbox" name="chkall" onClick="chkallClick(this);"></th>
		...
		<th width="48" class="title"><a class="title" href="<?php echo getLinkSort(2)?>">Mã sản phẩm</a></th>
		...
		<th width="56" class="title"><a class="title" href="<?php echo getLinkSort(11)?>">Ẩn sp</a></th>

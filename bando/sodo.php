...
text= "<b style='color:#00F' " + 
         "style='text-align:center'>phonghanh<br />" + 
     "<img src='local.png' width='50px'/></b>";
...
<body onLoad="initialize()">
    ...
    <table width="61%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td width="2%">&nbsp;</td>
        <td width="98%"><div align="center" class="style9">
				<image src="CuliCoderLogo.png" alt="CuliCoder-Group" width="125px" height="70px"/><br>
				<strong>A product of CuliCoder</strong><br>
                Copyright © 2015 Merthushala. All rights reserved.<br></div></td>
      </tr>
